...
**Интегрированная в интерфейс** кнопка, которая направляет по прямой ссылке на просмотр фильма или сериала на **[Kinobox](https://kinobox.in/movie/{ID})** прямо из интерфейса **[Кинопоиска](https://www.kinopoisk.ru)**.
